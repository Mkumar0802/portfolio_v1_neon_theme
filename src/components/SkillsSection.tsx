  ...
  const skillCategories = [
    {
      title: 'Frontend',
      color: 'neon-blue',
      skills: ['React.js', 'Next.js', 'JavaScript', 'HTML5', 'CSS3', 'TailwindCSS', 'Bootstrap']
    },
    {
      title: 'Backend',
      color: 'neon-pink',
    ...
    },
    {
      title: 'Tools & Others',
      color: 'neon-purple',
      skills: ['Git', 'Jenkins', 'Linux', 'Digital Ocean', 'CI/CD', 'WordPress']
    }
  ];
      ...
      <div className="container mx-auto">
        ...
        <div className="mt-16 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 max-w-4xl mx-auto">
            {['MERN Stack', 'Laravel', 'TailwindCSS', 'Digital Ocean', 'Jenkins CI/CD', 'WhatsApp API', 'Third-party Integrations'].map((tech, index) => (
              <span 
                key={tech}
