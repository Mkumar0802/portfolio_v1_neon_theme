    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="text-center z-10 max-w-4xl mx-auto px-6">
        ...
        <div className="mb-8">
          ...
          {/* Animated Subtitle */}
          <div className="text-2xl md:text-4xl font-display font-bold text-secondary min-h-[3rem] flex items-center justify-center">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center fade-in-up delay-700">
          ...
          <button className="px-6 py-3 font-semibold border border-secondary text-secondary hover:bg-secondary hover:text-secondary-foreground transition-all duration-300 neon-text-pink">
            GET IN TOUCH
          </button>
        </div>
        
        {/* Contact Info */}
        <div className="mt-16 flex flex-wrap justify-center gap-8 text-muted-foreground fade-in-up delay-700">
